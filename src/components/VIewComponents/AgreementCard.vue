<template>
    <q-dialog v-model="showAgreement" persistent full-height>
      <q-card v-if="user_agreement" bordered class="column no-wrap article" style="min-width: 61vw; max-width: 1440px;">
