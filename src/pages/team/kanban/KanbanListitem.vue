            ...
            <template v-if="useAuths('title', ['kanban'])">
              ...
              <template v-if="useAuths('delete', ['kanban'])">
                ...
                >
                  ...
                  <q-item-section v-if="teamStore.kanban?.type === 'segment'">{{ $t('remove_this_reel') }}</q-item-section>
                  <q-item-section v-if="teamStore.kanban?.type === 'classroom'">{{ $t('remove_this_chapter') }}</q-item-section>
                </q-item>
              </template>
            </q-list>
          </q-menu>
